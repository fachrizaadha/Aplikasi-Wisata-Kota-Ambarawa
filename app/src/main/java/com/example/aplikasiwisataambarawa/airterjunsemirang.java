...
public class airterjunsemirang extends AppCompatActivity {
    ...
    final String air = "-7.165511,110.3815683"; // koordinat Air Terjun Semirang
    /*Deklarasi variable*/

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_airterjunsemirang);

        btn_air = findViewById(R.id.btn_air);
        ...
        btn_air.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                gmmIntentUri1[0] = Uri.parse("google.navigation:q=" + air);
                ...
                if (mapIntent1[0].resolveActivity(getPackageManager()) != null) {
                    ...
                    Toast.makeText( airterjunsemirang.this ,"Google Maps Belum Terinstal. Install Terlebih dahulu.",
