...
public class sidomukti extends AppCompatActivity {
    ...
    final String umbul = "-7.1942362,110.3675756"; // koordinat Sido Mukti
    /*Deklarasi variable*/
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_umbul = findViewById(R.id.btn_umbul);

        // tombol untuk menjalankan navigasi goolge maps intents
        btn_umbul.setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View v) {

                // Buat Uri dari intent string. Gunakan hasilnya untuk membuat Intent.
                gmmIntentUri1[0] = Uri.parse("google.navigation:q=" + umbul);
                ...
                if (mapIntent1[0].resolveActivity(getPackageManager()) != null) {
                    ...
                    Toast.makeText(sidomukti.this, "Google Maps Belum Terinstal. Install Terlebih dahulu.",
